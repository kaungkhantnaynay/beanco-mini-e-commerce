...
- [ ] Define totals, rounding, tax, shipping, expiry, and stock-reservation rules.
- [ ] Implement guest cart tokens stored in secure cookies.
- [ ] Implement cart retrieval and add/update/remove operations.
- [ ] Re-fetch prices and validate active products/variants on every mutation.
- [ ] Add backend-computed subtotal, discount, shipping, tax, and total fields.
- [ ] Implement address validation and available shipping methods.
